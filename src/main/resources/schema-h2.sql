...
CREATE TABLE research_group (
    ...
    colciencias_category VARCHAR2(2 CHAR) NOT NULL,
    description          VARCHAR2(500 CHAR) NOT NULL,
    leader_id            NUMBER(10) NOT NULL,
    nprogram_id          NUMBER(10),
    institution_id       NUMBER(10),
    citizen_id           VARCHAR2(20 CHAR) NOT NULL,
    nationality          VARCHAR2(20 CHAR) NOT NULL,
    second_last_name     VARCHAR2(20 CHAR),
    country_of_birth     VARCHAR2(30 CHAR) NOT NULL
);
...
COMMENT ON COLUMN research_group.colciencias_category IS
    'A1, B, etc.';
...
CREATE TABLE research_paper (
    ...
    academic_journal VARCHAR2(50 CHAR) NOT NULL
);
...
CREATE TABLE "resource" (
    ...
    resource_url  VARCHAR2(200 CHAR) NOT NULL,
...
CREATE TABLE rproject_rpapers (
    ...
    is_project_member   RAW(2000) NOT NULL
);
...
ALTER TABLE research_group
    ADD CONSTRAINT research_group_users_fk FOREIGN KEY ( leader_id )
        REFERENCES users ( id );
